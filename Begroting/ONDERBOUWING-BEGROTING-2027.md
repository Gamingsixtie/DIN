...
> **Actualisatie 11-08-2026:** cijfers bijgewerkt van de snapshot van 6 mei (3.413 uur) naar de actuele live sessie (versie 2594, laatst gewijzigd 9 juli 2026): **3.484 uur** (+71). Oorzaak: RASCI-herberekening van kernteam- en leiderumen, Product Owner systemen van geconsulteerd naar kernteam (3 → 46 u), rol Commercieel manager toegevoegd (3 u) en drie kleine geconsulteerd-rollen vervallen (accountmanager prof −9, content specialist −14, productowner website −3). **De out-of-pocket-kant is ongewijzigd** (€ 301.500, zelfde verdeling).
...
1. **43% van alle programma-uren valt in 2027.** Het vijfjarige scenario kent 8.166 uur; 2026 is aanloop (330 u), 2027 (3.484 u) en 2028 zijn de uitvoeringsjaren, daarna zakt het sterk terug. In 2027 vallen **twee zware sporen samen**: het eerste trainingsblok én het CRM-realisatiejaar.
...
4. **Cultuur: 464 uur + Processen: 382 uur.** Leiderschapsprogramma (9 leidinggevenden × ± 41 uur deelname) plus HR-instrumentarium, en de werkgroep procesherontwerp met pilots per sector.
