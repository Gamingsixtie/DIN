...
export default function KPIMeetbaarheidStep() {
  ...
  return (
    <div className="max-w-[1300px] mx-auto px-1 pb-24">
      {/* ---------- Kop (stap-titel komt uit de sessie-pagina) ---------- */}
      <div className="flex items-center gap-2 flex-wrap -mt-2 mb-5">
        ...
        <p className="text-sm text-gray-600 leading-relaxed">
          Het <b>definitieve KPI-model</b> — uitkomst stakeholdersessie.
          Startwaarden volgen uit de nulmeting (Q3); doelwaarden en
          vermogen-indicatoren bepalen we in de vervolgsessie.
        </p>
      </div>
