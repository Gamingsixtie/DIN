...
const DOSSIERS: DossierEntry[] = [
  ...
  },
  {
    ...
    eenmaligMax: 86_000,
    eenmaligMid: 78_000,
    structureelPerJaar: 12_000,
    toelichting:
      "Eenmalig € 78.000 (procesbegeleiding € 62.000 + governance-instrumentarium € 10.000 + sectorvariatie-buffer € 6.000). Structureel ~€ 12.000/jaar voor proceseigenaarschap-borging via Smartprocess (bestaande tooling).",
  },
  {
    match: "gesprek",
    label: "Gespreksvaardigheidstraining (80 deelnemers)",
    eenmaligMin: 145_000,
    eenmaligMax: 165_000,
    eenmaligMid: 155_000,
    structureelPerJaar: 0,
    toelichting:
      "Eenmalig € 155.000 voor 80 deelnemers (vast € 75K + variabel € 80K). Geen vaste structurele last; voor langere scenario's komt jaarlijks € 15K refresh + € 5K onboarding vanaf jaar 4 erbij — dat zit in scenario-totaal niet in dossier-mid.",
  },
  {
    match: "leiderschap",
    label: "Leiderschapsprogramma (9 lg + 2 HR)",
    eenmaligMin: 100_000,
    eenmaligMax: 117_000,
    eenmaligMid: 108_500,
    structureelPerJaar: 7_500,
    toelichting:
      "Eenmalig € 108.500 (externe begeleider € 37.500 + executive-tarief reservering € 20.000 + individuele coaching 9 lg × € 4.000 + HR-instrumentarium € 15.000). Structureel ~€ 5K-€ 9.500/jaar (360°-tool € 5K/jr + cultuurmeting + onboarding nieuwe leiders).",
  },
  {
    match: "post onvoorzien",
    label: "Post onvoorzien (programma-breed)",
    eenmaligMin: 17_000,
    eenmaligMax: 140_000,
    eenmaligMid: 91_000,
    structureelPerJaar: 0,
    toelichting:
      "Programma-brede risico-buffer voor scope-uitloop, marktrisico tarieven, herbewerking en onvoorziene integratie-issues. Hoogte verschilt per scenario — circa 10 % van basisraming waar cap-headroom dat toelaat (Snelste € 122K, +20% € 135K, Huidig € 140K), symbolische € 17K voor −20% (cap zit krap).",
  },
  {
    match: "klantfeedback",
...
const COMPONENT_BREAKDOWNS: ComponentBreakdown[] = [
  ...
  },
  {
    ...
    eenmaligComponents: [
      {
        naam: "Externe procesbegeleider",
        rangeMin: 14_000,
        rangeMax: 20_000,
        toelichting: "20 dagen × € 800/dag (Cito-benchmark)",
        formule: "20 dagen × € 800/dag (Cito-benchmark)",
        berekeningMid: "20 × € 800 = € 16.000",
        tariefOnderbouwing: "Cito-benchmark procesbegeleider: € 800/dag (max-fee)",
        aantalOnderbouwing: "20 dagen verspreid over inventarisatie + herontwerp",
      },
      {
        naam: "Sessiebegeleiding 9 multidisciplinaire werksessies",
        rangeMin: 17_000,
        rangeMax: 23_000,
        toelichting: "9 sessies × € 2.200 incl. voorbereiding",
        formule: "9 sessies × € 2.200 incl. voorbereiding",
        berekeningMid: "9 × € 2.222 = € 20.000",
        tariefOnderbouwing: "Externe procesfacilitator: € 1.800-€ 2.500/sessie incl. voorbereiding",
        aantalOnderbouwing: "9 multidisciplinaire werksessies (PO/VO/Prof + cross-sectoraal)",
      },
      {
        naam: "Methodieken + materialen",
        rangeMin: 6_000,
        rangeMax: 10_000,
        toelichting: "Smartprocess-templates + handleidingen + KPI-format",
        formule: "Smartprocess-templates + handleidingen + KPI-format",
        berekeningMid: "€ 7.500 vast voor procesinrichting + handleidingen + materialen",
        tariefOnderbouwing: "Eenmalige methodiek-bouw: € 6K-€ 10K",
        aantalOnderbouwing: "Cross-sectoraal toepasbaar bij 21 medewerkers",
      },
      {
        naam: "Cross-sectoraal governance-instrumentarium",
        rangeMin: 8_000,
        rangeMax: 12_000,
        toelichting: "KPI-template + integratie-format CRM eenmalig",
        formule: "KPI-template + integratie-format CRM eenmalig",
        berekeningMid: "€ 10.000 voor governance-tooling + KPI-dashboard-integratie",
        tariefOnderbouwing: "Eenmalige tooling-integratie: € 8K-€ 12K",
        aantalOnderbouwing: "1 cross-sectoraal funnelkader",
      },
      {
        naam: "Sectorvariatie-buffer",
        rangeMin: 5_000,
        rangeMax: 7_000,
        toelichting: "10 % herbewerking op eenmalig basis",
        formule: "10 % herbewerking op eenmalig basis",
        berekeningMid: "10 % × € 60.000 ≈ € 6.000",
        tariefOnderbouwing: "Buffer-percentage 10 % standaard procesinrichting",
        aantalOnderbouwing: "Dekt herbewerking bij late funneldefinitie-besluiten",
      },
    ],
    structureelComponents: [
      {
        naam: "Proceseigenaarschap-borging Smartprocess",
        perJaarMin: 10_000,
        perJaarMax: 15_000,
        toelichting: "Smartprocess-gebruik 4-8u/maand × 3 sectoren binnen formatie",
        formule: "Smartprocess-gebruik 4-8u/maand × 3 sectoren binnen formatie",
        berekeningMin: "€ 10.000 minimale procesreview-cyclus",
        berekeningMax: "€ 15.000 inclusief governance-cyclus + KPI-rapportage",
        tariefOnderbouwing: "Smartprocess-tooling bestaand (geen separate licentie); inzet 12u/maand cross-sectoraal",
        aantalOnderbouwing: "3 sectoren PO/VO/Prof × eigen procesondersteuner",
      },
    ],
    structureelNote:
      "Smartprocess is bestaande tooling — geen separate licentiekost. Borging via formatie-uren binnen 4-8u/maand per procesondersteuner.",
  },
  {
    match: "gesprek",
    ...
    eenmaligComponents: [
      {
        naam: "LMS-licentie 5+ jaar",
        rangeMin: 25_000,
        rangeMax: 35_000,
        toelichting: "vaste licentie eenmalig",
        formule: "vaste licentie eenmalig",
        berekeningMid: "€ 30.000 voor 80 gebruikers, 5+ jaar levensduur",
        tariefOnderbouwing: "Marktconforme LMS-licentie nederland (Cornerstone/SuccessFactors-equivalent)",
        aantalOnderbouwing: "85 gebruikers gelijk aan CRM-doelgroep",
      },
      {
        naam: "Content-ontwikkeling outside-in curriculum",
        rangeMin: 20_000,
        rangeMax: 30_000,
        toelichting: "5 modules × € 5K + sectorinkleuring",
        formule: "5 modules × € 5K + sectorinkleuring",
        berekeningMid: "5 modules × € 5.000 = € 25.000 incl. 4 sector-varianten (PO/VO/Zakelijk/Prof)",
        tariefOnderbouwing: "L&D-content development tarief Nederland: € 4.000-€ 6.000 per module",
        aantalOnderbouwing: "5 modules outside-in basis-vaardigheid",
      },
      {
        naam: "Train-de-trainer (12 interne A-trainers)",
        rangeMin: 8_000,
        rangeMax: 12_000,
        toelichting: "12 trainers × € 800 begeleidingsdagen",
        formule: "12 trainers × € 800 begeleidingsdagen",
        berekeningMid: "12 × € 833 = € 10.000 voor 1-daagse train-de-trainer-sessies",
        tariefOnderbouwing: "Externe master-trainer Nederland: € 800-€ 1.200/dag",
        aantalOnderbouwing: "12 trainer/adviseurs A uit Stap 7",
      },
      {
        naam: "Nulmeting + intake",
        rangeMin: 8_000,
        rangeMax: 12_000,
        toelichting: "intake 80 deelnemers + analyse + rapport",
        formule: "intake 80 deelnemers + analyse + rapport",
        berekeningMid: "80 × € 100 nulmeting + € 2.000 analyse = € 10.000",
        tariefOnderbouwing: "Online assessment-tool: € 75-€ 125/p.p.",
        aantalOnderbouwing: "80 deelnemers Stap 7",
      },
      {
        naam: "Externe trainingspartner 2 blokken",
        rangeMin: 55_000,
        rangeMax: 70_000,
        toelichting: "2 blokken × € 31.500 voor 80 pers.",
        formule: "2 blokken × € 31.500 voor 80 pers.",
        berekeningMid: "2 × € 31.500 = € 63.000 inclusief commerciële module",
        tariefOnderbouwing: "Externe trainingspartner all-in NL: € 26K/blok bij 66 pers., € 31,5K/blok bij 80 pers.",
        aantalOnderbouwing: "2 blokken × 3 maanden voor 80 deelnemers",
      },
      {
        naam: "Sessieondersteuning + locatie + materialen",
        rangeMin: 14_000,
        rangeMax: 20_000,
        toelichting: "sessie-overhead 80 deelnemers",
        formule: "sessie-overhead 80 deelnemers",
        berekeningMid: "€ 17.000 voor locatie, lunch, materialen, planning over 2 blokken",
        tariefOnderbouwing: "Cito-benchmark sessie-overhead: € 200-€ 250/p.p.",
        aantalOnderbouwing: "80 deelnemers",
      },
    ],
    structureelComponents: [],
    structureelNote:
      "Geen structurele last; voor langere scenario's komt jaarlijks € 15K refresh + € 5K onboarding vanaf jaar 4 (zit in scenario-totaal, niet in basis-eenmalig).",
  },
  {
    match: "leiderschap",
    ...
    eenmaligComponents: [
      {
        naam: "Externe begeleider 15 dagen",
        rangeMin: 33_750,
        rangeMax: 41_250,
        toelichting: "15 × € 2.500/dag",
        formule: "15 × € 2.500/dag",
        berekeningMid: "15 × € 2.500 = € 37.500",
        tariefOnderbouwing: "Senior leiderschapscoach NL: € 2.250-€ 2.750/dag",
        aantalOnderbouwing: "15 dagen begeleiding cross-sectorale leerkringen",
      },
      {
        naam: "Executive-tarief reservering",
        rangeMin: 15_000,
        rangeMax: 25_000,
        toelichting: "buffer voor executive-coaches tot € 4.000/dag",
        formule: "buffer voor executive-coaches tot € 4.000/dag",
        berekeningMid: "€ 20.000 reservering bij escalatie naar exec-tarief",
        tariefOnderbouwing: "Executive-coach NL: € 3.000-€ 4.500/dag",
        aantalOnderbouwing: "Reservering voor maximaal 5-7 dagen exec-niveau",
      },
      {
        naam: "Individuele coaching 9 leidinggevenden",
        rangeMin: 32_000,
        rangeMax: 40_000,
        toelichting: "9 lg × € 4.000 (1 dag/lg/jr met externe coach in basis-jaren)",
        formule: "9 lg × € 4.000 (1 dag/lg/jr met externe coach in basis-jaren)",
        berekeningMid: "9 × € 4.000 = € 36.000",
        tariefOnderbouwing: "Individuele leiderschapscoaching: € 3.500-€ 4.500/dag",
        aantalOnderbouwing: "9 leidinggevenden Stap 7",
      },
      {
        naam: "HR-instrumentarium aanpassing",
        rangeMin: 12_000,
        rangeMax: 18_000,
        toelichting: "functioneringscyclus + 360°-integratie",
        formule: "functioneringscyclus + 360°-integratie",
        berekeningMid: "€ 15.000 voor HR-cycle herontwerp + 360°-koppeling",
        tariefOnderbouwing: "HR-consultancy NL: € 1.000-€ 1.300/dag × 12-15 dagen",
        aantalOnderbouwing: "Cross-sectoraal: 1 HR-cyclus voor PO/VO/Prof",
      },
    ],
    structureelComponents: [
      {
        ...
        perJaarMin: 4_000,
        perJaarMax: 6_000,
        toelichting: "9 lg × € 500/jr licentie",
        formule: "9 lg × € 500/jr licentie",
        berekeningMin: "9 × € 444 ≈ € 4.000 minimale tooling",
        berekeningMax: "9 × € 666 ≈ € 6.000 incl. premium-features",
        tariefOnderbouwing: "360°-feedback-platform NL: € 400-€ 700/p.p./jaar",
        aantalOnderbouwing: "9 leidinggevenden + uitbreidbaar voor onboarding",
      },
      {
        naam: "Cultuurmeting jaarlijks (vanaf jaar 3)",
        perJaarMin: 2_000,
        perJaarMax: 3_000,
        toelichting: "1× per jaar × € 2.500",
        formule: "1× per jaar × € 2.500",
        berekeningMin: "€ 2.000 minimale schaal",
        berekeningMax: "€ 3.000 incl. analyse + rapport",
        tariefOnderbouwing: "Online cultuur-survey: € 2K-€ 3K all-in",
        aantalOnderbouwing: "Vanaf jaar 3, jaarlijkse meting voor 12-18 mnd verankering",
      },
      {
        naam: "Onboarding nieuwe leiders (vanaf jaar 5)",
        perJaarMin: 1_500,
        perJaarMax: 2_500,
        toelichting: "geschat 1-2 nieuwe leiders × € 1.500-€ 2.500",
        formule: "geschat 1-2 nieuwe leiders × € 1.500-€ 2.500",
        berekeningMin: "1 nieuwe lg × € 1.500",
        berekeningMax: "2 nieuwe lg × € 1.250",
        tariefOnderbouwing: "Onboarding-budget per nieuwe leider: € 1.500-€ 2.500",
        aantalOnderbouwing: "1-2 nieuwe leidinggevenden per jaar in lange scenario's",
      },
    ],
    structureelNote:
      "Structurele last varieert per scenario: 4j (alleen 360°-tool), 5j (+ 1× cultuurmeting), 7j (+ 5× cultuurmeting + 3j onboarding), 10j (+ 8× cultuurmeting + 6j onboarding).",
  },
  {
    match: "post onvoorzien",
    label: "Post onvoorzien (programma-breed)",
    eenmaligComponents: [
      {
        naam: "Risico-buffer programma-breed",
        rangeMin: 17_000,
        rangeMax: 140_000,
        toelichting: "10 % van basisraming (CRM + Mens + Processen + Cultuur), gecapt door scenario-headroom",
        formule: "10 % van basisraming (CRM + Mens + Processen + Cultuur), gecapt door scenario-headroom",
        berekeningMin: "−20% scenario: € 17.000 (cap-marge tot € 200K/jaar dwingt buffer naar nul)",
        berekeningMid: "Snelste € 122K · +20% € 135K · Huidig € 140K — circa 10 % van basisraming",
        berekeningMax: "Bij ruimere cap zou 15 % standaard zijn (PRINCE2/PMI voor IT-implementatie)",
        tariefOnderbouwing: "Industry-standard PM/risico-buffer: 8-15 % voor € 0,5M-€ 1M IT-projecten",
        aantalOnderbouwing: "Programma-breed (alle 4 inspanningen) — niet pre-toegewezen, vrijval terug naar programma-budget",
      },
    ],
    structureelComponents: [],
    structureelNote:
      "Geen structurele last; eenmalig over scenario-looptijd verdeeld vanaf jaar 2 (jaar 1 is hard op Cito-budget € 250K / € 200K). Bij realisatie risico: post wordt aangesproken; bij uitblijven: vrijval terug naar programma-budget.",
  },
];
