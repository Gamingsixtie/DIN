/**
 * Converteer de medewerkers-deck (/medewerkers) naar PowerPoint — vanaf een lokale server.
 * Vereist een draaiende server op http://localhost:3000 (npm run start).
 * Run:  node scripts/build-medewerkers-pptx.cjs
 */
const fs = require("fs");
...
const URL = "http://localhost:3000/medewerkers";
const OUT_DIR = path.join(require("os").tmpdir(), "medewerkers-slides");
const PPTX = "C:\\Users\\pdebu\\Downloads\\Klant-in-Zicht-Medewerkers.pptx";
