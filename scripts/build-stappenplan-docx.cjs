  ...
  sections: [{
    ...
    children: [
      ...
      stappenTabel([
        ...
        stap(4, CITO, [b("Adoptie-framework bouwen & vaststellen")], [b("Wat we doen: "), r("in werksessies vertalen we de klantreizen volgens de vaste logica klantreis → klantbehoefte → kritisch contactmoment → gewenst medewerkergedrag → competenties → KPI's: per rol leggen we vast welk gedrag we op de kritische contactmomenten willen zien en welke competenties daarvoor nodig zijn — die meetpunten worden de vermogen-indicatoren. Daarnaast richten we het Adoptie Team met ambassadeurs per sector in. Het framework leggen we vervolgens voor aan de sectormanagers en HR — zo creëren we draagvlak vóór we het vaststellen. "), b("Resultaat: "), r("een adoptie-framework dat gereed & gedragen is door het programmateam (mijlpaal Q3) + de basis voor de vermogen-indicatoren (stap 6).")], "3sides · sectormanagers · HR · teamleden per rol (marketeers, productmanagers)", "Q3"),
